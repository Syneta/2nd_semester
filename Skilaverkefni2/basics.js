...
console.log(getFirstChar("Bíngó"))
...
console.log(getNthChar("bingó",5))
...
console.log(extractFirstHalfOfString("bondi"))
...
console.log(removeLastNChractersOfString('Sigurjón'))
...
console.log(checkIfNumberIsEven(100))
...
console.log(getPercentageOfNumber(3,1))
